...
export class PB_UpdateEntityComponent extends jspb.Message {
  ...
  static deserializeBinaryFromReader(message: PB_UpdateEntityComponent, reader: jspb.BinaryReader): PB_UpdateEntityComponent;
}
...
export class PB_AttachEntityComponent extends jspb.Message {
  ...
  static deserializeBinaryFromReader(message: PB_AttachEntityComponent, reader: jspb.BinaryReader): PB_AttachEntityComponent;
}
