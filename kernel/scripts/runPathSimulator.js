...
const path = (name) => {
    switch (name) {
        ...
        case '/walk':
            return sequence(walkTo(384, 320), walkTo(320, 384), walkTo(384, 320), walkTo(320, 384), walkTo(384, 320), walkTo(320, 384), walkTo(384, 320), walkTo(320, 384), walkTo(384, 320), walkTo(320, 384), walkTo(384, 320), walkTo(320, 384), walkTo(384, 320), walkTo(320, 384), walkTo(384, 320), walkTo(320, 384), walkTo(384, 320), walkTo(320, 384), walkTo(384, 320), walkTo(320, 384), walkTo(384, 320), walkTo(320, 384), walkTo(384, 320), walkTo(320, 384), walkTo(384, 320), logOut());
    }
};
...
async function resume(position, path, ws, alias) {
    const iterator = path();
