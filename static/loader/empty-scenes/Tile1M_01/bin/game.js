...
const gltfShape_2 = new GLTFShape('models/Bush_01/Bush_01.glb')
bush_01.addComponentOrReplace(gltfShape_2)
const transform_3 = new Transform({
  position: new Vector3(4, 0, 3),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
bush_01.addComponentOrReplace(transform_3)
engine.addEntity(bush_01)

const bush_02 = new Entity()
bush_02.setParent(scene)
const gltfShape_3 = new GLTFShape('models/Bush_02/Bush_02.glb')
bush_02.addComponentOrReplace(gltfShape_3)
const transform_4 = new Transform({
  position: new Vector3(11, 0, 12),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
bush_02.addComponentOrReplace(transform_4)
engine.addEntity(bush_02)

const treeSycamore_01 = new Entity()
treeSycamore_01.setParent(scene)
const gltfShape_4 = new GLTFShape('models/TreeSycamore_01/TreeSycamore_01.glb')
treeSycamore_01.addComponentOrReplace(gltfShape_4)
const transform_5 = new Transform({
  position: new Vector3(11.5, 0, 4),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
treeSycamore_01.addComponentOrReplace(transform_5)
engine.addEntity(treeSycamore_01)

const rockSmall_01 = new Entity()
rockSmall_01.setParent(scene)
const gltfShape_5 = new GLTFShape('models/RockSmall_01/RockSmall_01.glb')
rockSmall_01.addComponentOrReplace(gltfShape_5)
...
rockSmall_01.addComponentOrReplace(transform_6)
engine.addEntity(rockSmall_01)

const rockSmall_02 = new Entity()
rockSmall_02.setParent(scene)
const gltfShape_6 = new GLTFShape('models/RockSmall_02/RockSmall_02.glb')
rockSmall_02.addComponentOrReplace(gltfShape_6)
...
rockSmall_02.addComponentOrReplace(transform_7)
engine.addEntity(rockSmall_02)

const rockMedium_01 = new Entity()
rockMedium_01.setParent(scene)
const gltfShape_7 = new GLTFShape('models/RockMedium_01/RockMedium_01.glb')
rockMedium_01.addComponentOrReplace(gltfShape_7)
const transform_8 = new Transform({
  position: new Vector3(5, 0, 4.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
rockMedium_01.addComponentOrReplace(transform_8)
engine.addEntity(rockMedium_01)

const mushroom_02 = new Entity()
mushroom_02.setParent(scene)
const gltfShape_8 = new GLTFShape('models/Mushroom_02/Mushroom_02.glb')
mushroom_02.addComponentOrReplace(gltfShape_8)
const transform_9 = new Transform({
  position: new Vector3(10, 0, 11),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
mushroom_02.addComponentOrReplace(transform_9)
engine.addEntity(mushroom_02)

const log_02 = new Entity()
log_02.setParent(scene)
const gltfShape_9 = new GLTFShape('models/Log_02/Log_02.glb')
log_02.addComponentOrReplace(gltfShape_9)
const transform_10 = new Transform({
  position: new Vector3(3.5, 0, 10),
  rotation: new Quaternion(0, 0.4713967368259977, 0, 0.881921264348355),
  scale: new Vector3(1, 1, 1)
})
log_02.addComponentOrReplace(transform_10)
...
pebble_01.addComponentOrReplace(transform_11)
...
pebble_02.addComponentOrReplace(transform_12)
engine.addEntity(pebble_02)

const grass_01 = new Entity()
grass_01.setParent(scene)
const gltfShape_12 = new GLTFShape('models/Grass_01/Grass_01.glb')
grass_01.addComponentOrReplace(gltfShape_12)
const transform_13 = new Transform({
  position: new Vector3(8, 0, 7.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
grass_01.addComponentOrReplace(transform_13)
engine.addEntity(grass_01)

const grass_02 = new Entity()
grass_02.setParent(scene)
const gltfShape_13 = new GLTFShape('models/Grass_02/Grass_02.glb')
grass_02.addComponentOrReplace(gltfShape_13)
...
grass_02.addComponentOrReplace(transform_14)
engine.addEntity(grass_02)

const grass_03 = new Entity()
grass_03.setParent(scene)
const gltfShape_14 = new GLTFShape('models/Grass_03/Grass_03.glb')
grass_03.addComponentOrReplace(gltfShape_14)
const transform_15 = new Transform({
  position: new Vector3(14.5, 0, 5.5),
  rotation: new Quaternion(0, 0.9238795325112866, 0, 0.3826834323650897),
  scale: new Vector3(1, 1, 1)
})
grass_03.addComponentOrReplace(transform_15)
engine.addEntity(grass_03)

const grass_01_2 = new Entity()
grass_01_2.setParent(scene)
grass_01_2.addComponentOrReplace(gltfShape_12)
...
grass_01_2.addComponentOrReplace(transform_16)
engine.addEntity(grass_01_2)

const grass_02_2 = new Entity()
grass_02_2.setParent(scene)
grass_02_2.addComponentOrReplace(gltfShape_13)
const transform_17 = new Transform({
  position: new Vector3(6.5, 0, 2),
  rotation: new Quaternion(0.16127352578428178, -0.7956668099479275, 0.2413628880541374, 0.5316475653085997),
  scale: new Vector3(1, 1, 1)
})
grass_02_2.addComponentOrReplace(transform_17)
engine.addEntity(grass_02_2)

const grass_01_3 = new Entity()
grass_01_3.setParent(scene)
grass_01_3.addComponentOrReplace(gltfShape_12)
const transform_18 = new Transform({
  position: new Vector3(11, 0, 7),
  rotation: new Quaternion(0, 0.9238795325112865, 0, -0.38268343236508956),
  scale: new Vector3(1, 1, 1)
})
grass_01_3.addComponentOrReplace(transform_18)
engine.addEntity(grass_01_3)

const grass_01_4 = new Entity()
grass_01_4.setParent(scene)
grass_01_4.addComponentOrReplace(gltfShape_12)
const transform_19 = new Transform({
  position: new Vector3(13, 0, 1),
  rotation: new Quaternion(0, -0.47139673682599775, 0, 0.8819212643483552),
  scale: new Vector3(1, 1, 1)
})
grass_01_4.addComponentOrReplace(transform_19)
engine.addEntity(grass_01_4)

const grass_03_2 = new Entity()
grass_03_2.setParent(scene)
grass_03_2.addComponentOrReplace(gltfShape_14)
const transform_20 = new Transform({
  position: new Vector3(7.5, 0, 10.5),
  rotation: new Quaternion(0, 0.9951847266721969, 0, 0.09801714032956085),
  scale: new Vector3(1, 1, 1)
})
grass_03_2.addComponentOrReplace(transform_20)
