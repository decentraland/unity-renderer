...
grass_03.addComponentOrReplace(transform_5)
...
grass_01_2.addComponentOrReplace(transform_6)
...
const transform_7 = new Transform({
  ...
  rotation: new Quaternion(0, 0.9807852804032302, 0, -0.19509032201612814),
  scale: new Vector3(1, 1, 1)
})
grass_02_2.addComponentOrReplace(transform_7)
...
const transform_8 = new Transform({
  ...
  rotation: new Quaternion(0, 0.9951847266721968, 0, 0.09801714032956052),
  scale: new Vector3(1, 1, 1)
})
grass_01_3.addComponentOrReplace(transform_8)
...
grass_03_2.addComponentOrReplace(transform_9)
...
const transform_10 = new Transform({
  ...
  rotation: new Quaternion(0, 0.831469612302545, 0, -0.555570233019602),
  scale: new Vector3(1, 1, 1)
})
grass_02_3.addComponentOrReplace(transform_10)
engine.addEntity(grass_02_3)

const grass_01_4 = new Entity()
grass_01_4.setParent(scene)
grass_01_4.addComponentOrReplace(gltfShape_2)
...
grass_01_4.addComponentOrReplace(transform_11)
engine.addEntity(grass_01_4)
...
grass_03_3.addComponentOrReplace(transform_12)
engine.addEntity(grass_03_3)

const grass_03_4 = new Entity()
grass_03_4.setParent(scene)
grass_03_4.addComponentOrReplace(gltfShape_4)
const transform_13 = new Transform({
  position: new Vector3(11, 0, 13),
  rotation: new Quaternion(0, -0.6343932841636457, 0, 0.7730104533627371),
  scale: new Vector3(1, 1, 1)
})
grass_03_4.addComponentOrReplace(transform_13)
engine.addEntity(grass_03_4)

const treePine_01 = new Entity()
treePine_01.setParent(scene)
const gltfShape_5 = new GLTFShape('models/TreePine_01/TreePine_01.glb')
treePine_01.addComponentOrReplace(gltfShape_5)
...
treePine_01.addComponentOrReplace(transform_14)
engine.addEntity(treePine_01)

const treePine_03 = new Entity()
treePine_03.setParent(scene)
const gltfShape_6 = new GLTFShape('models/TreePine_03/TreePine_03.glb')
treePine_03.addComponentOrReplace(gltfShape_6)
const transform_15 = new Transform({
  position: new Vector3(12, 0, 4.5),
  rotation: new Quaternion(0, -0.831469612302545, 0, 0.5555702330196022),
  scale: new Vector3(1, 1, 1)
})
treePine_03.addComponentOrReplace(transform_15)
engine.addEntity(treePine_03)

const rockSmall_01 = new Entity()
rockSmall_01.setParent(scene)
const gltfShape_7 = new GLTFShape('models/RockSmall_01/RockSmall_01.glb')
rockSmall_01.addComponentOrReplace(gltfShape_7)
const transform_16 = new Transform({
  position: new Vector3(9, 0, 4),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
rockSmall_01.addComponentOrReplace(transform_16)
engine.addEntity(rockSmall_01)

const rockSmall_03 = new Entity()
rockSmall_03.setParent(scene)
const gltfShape_8 = new GLTFShape('models/RockSmall_03/RockSmall_03.glb')
rockSmall_03.addComponentOrReplace(gltfShape_8)
const transform_17 = new Transform({
  position: new Vector3(11.5, 0, 3),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
rockSmall_03.addComponentOrReplace(transform_17)
engine.addEntity(rockSmall_03)

const rockSmall_01_2 = new Entity()
rockSmall_01_2.setParent(scene)
rockSmall_01_2.addComponentOrReplace(gltfShape_7)
const transform_18 = new Transform({
  position: new Vector3(12, 0, 6),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
rockSmall_01_2.addComponentOrReplace(transform_18)
engine.addEntity(rockSmall_01_2)

const rockSmall_03_2 = new Entity()
rockSmall_03_2.setParent(scene)
rockSmall_03_2.addComponentOrReplace(gltfShape_8)
const transform_19 = new Transform({
  position: new Vector3(6, 0, 11),
  rotation: new Quaternion(0, -0.9951847266721974, 0, -0.09801714032956049),
  scale: new Vector3(1, 1, 1)
})
rockSmall_03_2.addComponentOrReplace(transform_19)
engine.addEntity(rockSmall_03_2)

const rockSmall_01_3 = new Entity()
rockSmall_01_3.setParent(scene)
rockSmall_01_3.addComponentOrReplace(gltfShape_7)
...
rockSmall_01_3.addComponentOrReplace(transform_20)
engine.addEntity(rockSmall_01_3)

const rockSmall_02 = new Entity()
rockSmall_02.setParent(scene)
const gltfShape_9 = new GLTFShape('models/RockSmall_02/RockSmall_02.glb')
rockSmall_02.addComponentOrReplace(gltfShape_9)
const transform_21 = new Transform({
  position: new Vector3(9, 0, 10.5),
  rotation: new Quaternion(0, -0.8314696123025456, 0, 0.5555702330196025),
  scale: new Vector3(1, 1, 1)
})
rockSmall_02.addComponentOrReplace(transform_21)
engine.addEntity(rockSmall_02)

const pebble_01 = new Entity()
pebble_01.setParent(scene)
const gltfShape_10 = new GLTFShape('models/Pebble_01/Pebble_01.glb')
pebble_01.addComponentOrReplace(gltfShape_10)
const transform_22 = new Transform({
  position: new Vector3(4, 0, 3.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
pebble_01.addComponentOrReplace(transform_22)
engine.addEntity(pebble_01)

const pebble_02 = new Entity()
pebble_02.setParent(scene)
const gltfShape_11 = new GLTFShape('models/Pebble_02/Pebble_02.glb')
pebble_02.addComponentOrReplace(gltfShape_11)
const transform_23 = new Transform({
  position: new Vector3(13, 0, 10.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
pebble_02.addComponentOrReplace(transform_23)
engine.addEntity(pebble_02)

const pebble_01_2 = new Entity()
pebble_01_2.setParent(scene)
pebble_01_2.addComponentOrReplace(gltfShape_10)
const transform_24 = new Transform({
  position: new Vector3(2.5, 0, 9.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
pebble_01_2.addComponentOrReplace(transform_24)
engine.addEntity(pebble_01_2)

const mushroom_02 = new Entity()
mushroom_02.setParent(scene)
const gltfShape_12 = new GLTFShape('models/Mushroom_02/Mushroom_02.glb')
mushroom_02.addComponentOrReplace(gltfShape_12)
const transform_25 = new Transform({
  position: new Vector3(7, 0, 8.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
mushroom_02.addComponentOrReplace(transform_25)
engine.addEntity(mushroom_02)

const mushroom_01 = new Entity()
mushroom_01.setParent(scene)
const gltfShape_13 = new GLTFShape('models/Mushroom_01/Mushroom_01.glb')
mushroom_01.addComponentOrReplace(gltfShape_13)
const transform_26 = new Transform({
  position: new Vector3(10.5, 0, 3.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
mushroom_01.addComponentOrReplace(transform_26)
engine.addEntity(mushroom_01)

const mushroom_02_2 = new Entity()
mushroom_02_2.setParent(scene)
mushroom_02_2.addComponentOrReplace(gltfShape_12)
const transform_27 = new Transform({
  position: new Vector3(12, 0, 12),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
mushroom_02_2.addComponentOrReplace(transform_27)
engine.addEntity(mushroom_02_2)

const plant_02 = new Entity()
plant_02.setParent(scene)
const gltfShape_14 = new GLTFShape('models/Plant_02/Plant_02.glb')
plant_02.addComponentOrReplace(gltfShape_14)
...
plant_02.addComponentOrReplace(transform_28)
engine.addEntity(plant_02)

const rockSmall_01_4 = new Entity()
rockSmall_01_4.setParent(scene)
rockSmall_01_4.addComponentOrReplace(gltfShape_7)
...
rockSmall_01_4.addComponentOrReplace(transform_29)
engine.addEntity(rockSmall_01_4)

const rockSmall_03_3 = new Entity()
rockSmall_03_3.setParent(scene)
rockSmall_03_3.addComponentOrReplace(gltfShape_8)
const transform_30 = new Transform({
  position: new Vector3(14, 0, 11.5),
  rotation: new Quaternion(0, 0.5555702330196022, 0, 0.8314696123025452),
  scale: new Vector3(1, 1, 1)
})
rockSmall_03_3.addComponentOrReplace(transform_30)
engine.addEntity(rockSmall_03_3)

const pebble_02_2 = new Entity()
pebble_02_2.setParent(scene)
pebble_02_2.addComponentOrReplace(gltfShape_11)
const transform_31 = new Transform({
  position: new Vector3(2.5, 0, 6.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
pebble_02_2.addComponentOrReplace(transform_31)
engine.addEntity(pebble_02_2)

const pebble_01_3 = new Entity()
pebble_01_3.setParent(scene)
pebble_01_3.addComponentOrReplace(gltfShape_10)
const transform_32 = new Transform({
  position: new Vector3(3, 0, 6.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
pebble_01_3.addComponentOrReplace(transform_32)
engine.addEntity(pebble_01_3)
