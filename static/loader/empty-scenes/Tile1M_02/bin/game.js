...
const gltfShape_2 = new GLTFShape('models/TreeSycamore_03/TreeSycamore_03.glb')
treeSycamore_03.addComponentOrReplace(gltfShape_2)
const transform_3 = new Transform({
  position: new Vector3(4, 0, 12.5),
  rotation: new Quaternion(0, 0.9951847266721969, 0, -0.09801714032956074),
  scale: new Vector3(1, 1, 1)
})
treeSycamore_03.addComponentOrReplace(transform_3)
engine.addEntity(treeSycamore_03)

const treeSycamore_01 = new Entity()
treeSycamore_01.setParent(scene)
const gltfShape_3 = new GLTFShape('models/TreeSycamore_01/TreeSycamore_01.glb')
...
treeSycamore_01.addComponentOrReplace(transform_4)
engine.addEntity(treeSycamore_01)

const pond_02 = new Entity()
pond_02.setParent(scene)
const gltfShape_4 = new GLTFShape('models/Pond_02/Pond_02.glb')
pond_02.addComponentOrReplace(gltfShape_4)
...
pond_02.addComponentOrReplace(transform_5)
engine.addEntity(pond_02)

const plant_02 = new Entity()
plant_02.setParent(scene)
const gltfShape_5 = new GLTFShape('models/Plant_02/Plant_02.glb')
plant_02.addComponentOrReplace(gltfShape_5)
const transform_6 = new Transform({
  position: new Vector3(8, 0, 12.5),
  rotation: new Quaternion(0, -0.8819212643483552, 0, 0.47139673682599775),
  scale: new Vector3(1, 1, 1)
})
plant_02.addComponentOrReplace(transform_6)
engine.addEntity(plant_02)

const plant_03 = new Entity()
plant_03.setParent(scene)
const gltfShape_6 = new GLTFShape('models/Plant_03/Plant_03.glb')
plant_03.addComponentOrReplace(gltfShape_6)
...
plant_03.addComponentOrReplace(transform_7)
engine.addEntity(plant_03)

const spiralStone_02 = new Entity()
spiralStone_02.setParent(scene)
const gltfShape_7 = new GLTFShape('models/SpiralStone_02/SpiralStone_02.glb')
spiralStone_02.addComponentOrReplace(gltfShape_7)
const transform_8 = new Transform({
  position: new Vector3(3.5, 0, 4.5),
  rotation: new Quaternion(0, 0.5555702330196025, 0, 0.8314696123025453),
  scale: new Vector3(1, 1, 1)
})
...
const gltfShape_8 = new GLTFShape('models/Grass_02/Grass_02.glb')
...
grass_02.addComponentOrReplace(transform_9)
engine.addEntity(grass_02)

const grass_03 = new Entity()
grass_03.setParent(scene)
const gltfShape_9 = new GLTFShape('models/Grass_03/Grass_03.glb')
grass_03.addComponentOrReplace(gltfShape_9)
const transform_10 = new Transform({
  position: new Vector3(12, 0, 4),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
grass_03.addComponentOrReplace(transform_10)
...
bush_03.addComponentOrReplace(transform_11)
engine.addEntity(bush_03)

const grass_01 = new Entity()
grass_01.setParent(scene)
const gltfShape_11 = new GLTFShape('models/Grass_01/Grass_01.glb')
grass_01.addComponentOrReplace(gltfShape_11)
const transform_12 = new Transform({
  position: new Vector3(12.5, 0, 13.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
grass_01.addComponentOrReplace(transform_12)
engine.addEntity(grass_01)

const grass_01_2 = new Entity()
grass_01_2.setParent(scene)
grass_01_2.addComponentOrReplace(gltfShape_11)
...
grass_01_3.addComponentOrReplace(gltfShape_11)
...
grass_01_4.addComponentOrReplace(gltfShape_11)
...
grass_02_2.addComponentOrReplace(gltfShape_8)
...
const grass_01_5 = new Entity()
grass_01_5.setParent(scene)
grass_01_5.addComponentOrReplace(gltfShape_11)
const transform_17 = new Transform({
  position: new Vector3(1.5, 0, 8),
  rotation: new Quaternion(0, -0.38268343236508984, 0, 0.9238795325112868),
  scale: new Vector3(1, 1, 1)
})
grass_01_5.addComponentOrReplace(transform_17)
engine.addEntity(grass_01_5)

const grass_03_2 = new Entity()
grass_03_2.setParent(scene)
grass_03_2.addComponentOrReplace(gltfShape_9)
...
grass_03_2.addComponentOrReplace(transform_18)
engine.addEntity(grass_03_2)

const grass_02_3 = new Entity()
grass_02_3.setParent(scene)
grass_02_3.addComponentOrReplace(gltfShape_8)
const transform_19 = new Transform({
  position: new Vector3(7.5, 0, 15),
  rotation: new Quaternion(0, -0.956940335732209, 0, 0.29028467725446255),
  scale: new Vector3(1, 1, 1)
})
grass_02_3.addComponentOrReplace(transform_19)
