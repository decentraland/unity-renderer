...
const gltfShape_3 = new GLTFShape('models/Grass_03/Grass_03.glb')
grass_03.addComponentOrReplace(gltfShape_3)
const transform_4 = new Transform({
  position: new Vector3(10, 0, 3.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
grass_03.addComponentOrReplace(transform_4)
engine.addEntity(grass_03)

const grass_03_2 = new Entity()
grass_03_2.setParent(scene)
grass_03_2.addComponentOrReplace(gltfShape_3)
...
grass_03_2.addComponentOrReplace(transform_5)
engine.addEntity(grass_03_2)

const grass_03_3 = new Entity()
grass_03_3.setParent(scene)
grass_03_3.addComponentOrReplace(gltfShape_3)
const transform_6 = new Transform({
  position: new Vector3(2, 0, 5.5),
  rotation: new Quaternion(0, -0.6343932841636455, 0, 0.7730104533627369),
  scale: new Vector3(1, 1, 1)
})
grass_03_3.addComponentOrReplace(transform_6)
engine.addEntity(grass_03_3)

const grass_02 = new Entity()
grass_02.setParent(scene)
const gltfShape_4 = new GLTFShape('models/Grass_02/Grass_02.glb')
grass_02.addComponentOrReplace(gltfShape_4)
...
grass_02.addComponentOrReplace(transform_7)
...
grass_01_2.addComponentOrReplace(transform_8)
...
grass_02_3.addComponentOrReplace(gltfShape_4)
const transform_12 = new Transform({
  position: new Vector3(10.5, 0, 9.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
grass_02_3.addComponentOrReplace(transform_12)
...
const transform_13 = new Transform({
  ...
  rotation: new Quaternion(0, 0.7071067811865475, 0, 0.7071067811865474),
  scale: new Vector3(1, 1, 1)
})
grass_05.addComponentOrReplace(transform_13)
engine.addEntity(grass_05)

const junglePlant_09 = new Entity()
junglePlant_09.setParent(scene)
const gltfShape_6 = new GLTFShape('models/JunglePlant_09/JunglePlant_09.glb')
junglePlant_09.addComponentOrReplace(gltfShape_6)
...
junglePlant_09.addComponentOrReplace(transform_14)
engine.addEntity(junglePlant_09)

const junglePlant_09_2 = new Entity()
junglePlant_09_2.setParent(scene)
junglePlant_09_2.addComponentOrReplace(gltfShape_6)
...
junglePlant_09_2.addComponentOrReplace(transform_15)
engine.addEntity(junglePlant_09_2)

const plant_02 = new Entity()
plant_02.setParent(scene)
const gltfShape_7 = new GLTFShape('models/Plant_02/Plant_02.glb')
plant_02.addComponentOrReplace(gltfShape_7)
...
plant_02.addComponentOrReplace(transform_16)
engine.addEntity(plant_02)

const plant_02_2 = new Entity()
plant_02_2.setParent(scene)
plant_02_2.addComponentOrReplace(gltfShape_7)
...
plant_02_2.addComponentOrReplace(transform_17)
engine.addEntity(plant_02_2)

const plant_03 = new Entity()
plant_03.setParent(scene)
const gltfShape_8 = new GLTFShape('models/Plant_03/Plant_03.glb')
plant_03.addComponentOrReplace(gltfShape_8)
const transform_18 = new Transform({
  position: new Vector3(11.5, 0, 12),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
plant_03.addComponentOrReplace(transform_18)
engine.addEntity(plant_03)

const plant_01 = new Entity()
plant_01.setParent(scene)
const gltfShape_9 = new GLTFShape('models/Plant_01/Plant_01.glb')
plant_01.addComponentOrReplace(gltfShape_9)
...
const gltfShape_10 = new GLTFShape('models/Bush_01/Bush_01.glb')
bush_01.addComponentOrReplace(gltfShape_10)
const transform_20 = new Transform({
  position: new Vector3(9.5, 0, 7),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
bush_01.addComponentOrReplace(transform_20)
engine.addEntity(bush_01)

const rockSmall_01 = new Entity()
rockSmall_01.setParent(scene)
const gltfShape_11 = new GLTFShape('models/RockSmall_01/RockSmall_01.glb')
rockSmall_01.addComponentOrReplace(gltfShape_11)
const transform_21 = new Transform({
  position: new Vector3(8, 0, 14),
  rotation: new Quaternion(0, 0.4713967368259976, 0, 0.881921264348355),
  scale: new Vector3(1, 1, 1)
})
rockSmall_01.addComponentOrReplace(transform_21)
