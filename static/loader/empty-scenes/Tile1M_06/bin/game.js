...
grass_03_2.addComponentOrReplace(transform_13)
...
treeTall_01.addComponentOrReplace(transform_14)
...
const gltfShape_11 = new GLTFShape('models/Bush_01/Bush_01.glb')
bush_01.addComponentOrReplace(gltfShape_11)
const transform_18 = new Transform({
  position: new Vector3(10, 0, 8),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
bush_01.addComponentOrReplace(transform_18)
...
const gltfShape_13 = new GLTFShape('models/Plant_02/Plant_02.glb')
plant_02.addComponentOrReplace(gltfShape_13)
...
plant_02.addComponentOrReplace(transform_20)
engine.addEntity(plant_02)

const rockSmall_03 = new Entity()
rockSmall_03.setParent(scene)
const gltfShape_14 = new GLTFShape('models/RockSmall_03/RockSmall_03.glb')
rockSmall_03.addComponentOrReplace(gltfShape_14)
const transform_21 = new Transform({
  position: new Vector3(6, 0, 2),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
rockSmall_03.addComponentOrReplace(transform_21)
