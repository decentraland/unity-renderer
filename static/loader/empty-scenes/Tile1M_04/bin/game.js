...
grass_01_2.addComponentOrReplace(transform_4)
...
grass_01_3.addComponentOrReplace(transform_5)
...
grass_02.addComponentOrReplace(transform_6)
...
grass_03.addComponentOrReplace(transform_8)
...
grass_01_4.addComponentOrReplace(transform_10)
...
grass_02_3.addComponentOrReplace(transform_11)
engine.addEntity(grass_02_3)

const treeRoundPine_02 = new Entity()
treeRoundPine_02.setParent(scene)
const gltfShape_5 = new GLTFShape('models/TreeRoundPine_02/TreeRoundPine_02.glb')
treeRoundPine_02.addComponentOrReplace(gltfShape_5)
const transform_12 = new Transform({
  position: new Vector3(12, 0, 6),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
treeRoundPine_02.addComponentOrReplace(transform_12)
engine.addEntity(treeRoundPine_02)

const treeRoundPine_01 = new Entity()
treeRoundPine_01.setParent(scene)
const gltfShape_6 = new GLTFShape('models/TreeRoundPine_01/TreeRoundPine_01.glb')
treeRoundPine_01.addComponentOrReplace(gltfShape_6)
const transform_13 = new Transform({
  position: new Vector3(2.5, 0, 6),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
treeRoundPine_01.addComponentOrReplace(transform_13)
engine.addEntity(treeRoundPine_01)

const treeRoundPine_03 = new Entity()
treeRoundPine_03.setParent(scene)
const gltfShape_7 = new GLTFShape('models/TreeRoundPine_03/TreeRoundPine_03.glb')
treeRoundPine_03.addComponentOrReplace(gltfShape_7)
const transform_14 = new Transform({
  position: new Vector3(7, 0, 13),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
treeRoundPine_03.addComponentOrReplace(transform_14)
engine.addEntity(treeRoundPine_03)

const rockSmall_01 = new Entity()
rockSmall_01.setParent(scene)
const gltfShape_8 = new GLTFShape('models/RockSmall_01/RockSmall_01.glb')
rockSmall_01.addComponentOrReplace(gltfShape_8)
const transform_15 = new Transform({
  position: new Vector3(2.5, 0, 4),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
rockSmall_01.addComponentOrReplace(transform_15)
engine.addEntity(rockSmall_01)

const rockMedium_02 = new Entity()
rockMedium_02.setParent(scene)
const gltfShape_9 = new GLTFShape('models/RockMedium_02/RockMedium_02.glb')
rockMedium_02.addComponentOrReplace(gltfShape_9)
const transform_16 = new Transform({
  position: new Vector3(12, 0, 7.5),
  rotation: new Quaternion(0, 0.9951847266721967, 0, 0.09801714032956056),
  scale: new Vector3(1, 1, 1)
})
rockMedium_02.addComponentOrReplace(transform_16)
engine.addEntity(rockMedium_02)

const rockMedium_01 = new Entity()
rockMedium_01.setParent(scene)
const gltfShape_10 = new GLTFShape('models/RockMedium_01/RockMedium_01.glb')
rockMedium_01.addComponentOrReplace(gltfShape_10)
const transform_17 = new Transform({
  position: new Vector3(6, 0, 13.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
rockMedium_01.addComponentOrReplace(transform_17)
engine.addEntity(rockMedium_01)

const rockMedium_02_2 = new Entity()
rockMedium_02_2.setParent(scene)
rockMedium_02_2.addComponentOrReplace(gltfShape_9)
...
rockMedium_02_2.addComponentOrReplace(transform_18)
engine.addEntity(rockMedium_02_2)

const mushroom_02 = new Entity()
mushroom_02.setParent(scene)
const gltfShape_11 = new GLTFShape('models/Mushroom_02/Mushroom_02.glb')
mushroom_02.addComponentOrReplace(gltfShape_11)
const transform_19 = new Transform({
  position: new Vector3(3.5, 0, 5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
mushroom_02.addComponentOrReplace(transform_19)
engine.addEntity(mushroom_02)

const mushroom_01 = new Entity()
mushroom_01.setParent(scene)
const gltfShape_12 = new GLTFShape('models/Mushroom_01/Mushroom_01.glb')
mushroom_01.addComponentOrReplace(gltfShape_12)
const transform_20 = new Transform({
  position: new Vector3(13, 0, 6),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
mushroom_01.addComponentOrReplace(transform_20)
engine.addEntity(mushroom_01)

const pebble_01 = new Entity()
pebble_01.setParent(scene)
const gltfShape_13 = new GLTFShape('models/Pebble_01/Pebble_01.glb')
pebble_01.addComponentOrReplace(gltfShape_13)
const transform_21 = new Transform({
  position: new Vector3(13, 0, 5.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
pebble_01.addComponentOrReplace(transform_21)
engine.addEntity(pebble_01)

const pebble_02 = new Entity()
pebble_02.setParent(scene)
const gltfShape_14 = new GLTFShape('models/Pebble_02/Pebble_02.glb')
pebble_02.addComponentOrReplace(gltfShape_14)
const transform_22 = new Transform({
  position: new Vector3(11.5, 0, 4.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
pebble_02.addComponentOrReplace(transform_22)
engine.addEntity(pebble_02)

const bush_01 = new Entity()
bush_01.setParent(scene)
const gltfShape_15 = new GLTFShape('models/Bush_01/Bush_01.glb')
bush_01.addComponentOrReplace(gltfShape_15)
const transform_23 = new Transform({
  position: new Vector3(8.5, 0, 14),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
bush_01.addComponentOrReplace(transform_23)
engine.addEntity(bush_01)

const bush_03 = new Entity()
bush_03.setParent(scene)
const gltfShape_16 = new GLTFShape('models/Bush_03/Bush_03.glb')
bush_03.addComponentOrReplace(gltfShape_16)
const transform_24 = new Transform({
  position: new Vector3(6.5, 0, 2.5),
...
const gltfShape_17 = new GLTFShape('models/Plant_02/Plant_02.glb')
plant_02.addComponentOrReplace(gltfShape_17)
const transform_25 = new Transform({
  position: new Vector3(12.5, 0, 12.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
plant_02.addComponentOrReplace(transform_25)
engine.addEntity(plant_02)

const rockMedium_03 = new Entity()
rockMedium_03.setParent(scene)
const gltfShape_18 = new GLTFShape('models/RockMedium_03/RockMedium_03.glb')
rockMedium_03.addComponentOrReplace(gltfShape_18)
const transform_26 = new Transform({
  position: new Vector3(8.5, 0, 9),
  rotation: new Quaternion(0, -0.9951847266721972, 0, 0.0980171403295609),
  scale: new Vector3(1, 1, 1)
})
rockMedium_03.addComponentOrReplace(transform_26)
engine.addEntity(rockMedium_03)

const mushroom_01_2 = new Entity()
mushroom_01_2.setParent(scene)
mushroom_01_2.addComponentOrReplace(gltfShape_12)
const transform_27 = new Transform({
  position: new Vector3(2, 0, 4.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
mushroom_01_2.addComponentOrReplace(transform_27)
