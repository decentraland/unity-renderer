...
grass_01_4.addComponentOrReplace(transform_6)
...
grass_02_2.addComponentOrReplace(transform_8)
...
grass_02_3.addComponentOrReplace(transform_9)
...
grass_03_2.addComponentOrReplace(transform_11)
engine.addEntity(grass_03_2)

const junglePlant_09 = new Entity()
junglePlant_09.setParent(scene)
const gltfShape_5 = new GLTFShape('models/JunglePlant_09/JunglePlant_09.glb')
junglePlant_09.addComponentOrReplace(gltfShape_5)
...
const gltfShape_6 = new GLTFShape('models/TreeStump_01/TreeStump_01.glb')
treeStump_01.addComponentOrReplace(gltfShape_6)
const transform_13 = new Transform({
  position: new Vector3(6.5, 0, 10),
  rotation: new Quaternion(0, -0.47139673682599775, 0, 0.8819212643483552),
  scale: new Vector3(1, 1, 1)
})
treeStump_01.addComponentOrReplace(transform_13)
...
rockSmall_01.addComponentOrReplace(transform_14)
...
const transform_15 = new Transform({
  position: new Vector3(9.5, 0, 12.5),
...
const transform_16 = new Transform({
  ...
  rotation: new Quaternion(0, -0.7730104533627374, 0, 0.6343932841636459),
  scale: new Vector3(1, 1, 1)
})
rockSmall_02.addComponentOrReplace(transform_16)
engine.addEntity(rockSmall_02)

const plant_07 = new Entity()
plant_07.setParent(scene)
const gltfShape_10 = new GLTFShape('models/Plant_07/Plant_07.glb')
plant_07.addComponentOrReplace(gltfShape_10)
const transform_17 = new Transform({
  position: new Vector3(4.5, 0, 12),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
plant_07.addComponentOrReplace(transform_17)
engine.addEntity(plant_07)

const plant_05 = new Entity()
plant_05.setParent(scene)
const gltfShape_11 = new GLTFShape('models/Plant_05/Plant_05.glb')
plant_05.addComponentOrReplace(gltfShape_11)
const transform_18 = new Transform({
  position: new Vector3(2.5, 0, 11.5),
  rotation: new Quaternion(0, -0.3826834323650897, 0, 0.9238795325112872),
  scale: new Vector3(1, 1, 1)
})
plant_05.addComponentOrReplace(transform_18)
