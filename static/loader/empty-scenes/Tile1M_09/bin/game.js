...
grass_02_2.addComponentOrReplace(transform_6)
...
const transform_7 = new Transform({
  position: new Vector3(5.5, 0, 3.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
grass_01_2.addComponentOrReplace(transform_7)
...
grass_05.addComponentOrReplace(transform_8)
...
grass_05_2.addComponentOrReplace(transform_9)
...
grass_01_3.addComponentOrReplace(transform_10)
engine.addEntity(grass_01_3)

const junglePlant_06 = new Entity()
junglePlant_06.setParent(scene)
const gltfShape_6 = new GLTFShape('models/JunglePlant_06/JunglePlant_06.glb')
junglePlant_06.addComponentOrReplace(gltfShape_6)
const transform_11 = new Transform({
  position: new Vector3(4, 0, 8),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
junglePlant_06.addComponentOrReplace(transform_11)
engine.addEntity(junglePlant_06)

const junglePlant_09 = new Entity()
junglePlant_09.setParent(scene)
const gltfShape_7 = new GLTFShape('models/JunglePlant_09/JunglePlant_09.glb')
junglePlant_09.addComponentOrReplace(gltfShape_7)
const transform_12 = new Transform({
  position: new Vector3(3, 0, 4),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
junglePlant_09.addComponentOrReplace(transform_12)
engine.addEntity(junglePlant_09)

const junglePlant_06_2 = new Entity()
junglePlant_06_2.setParent(scene)
junglePlant_06_2.addComponentOrReplace(gltfShape_6)
const transform_13 = new Transform({
  position: new Vector3(11, 0, 13.5),
  rotation: new Quaternion(0, -0.5555702330196024, 0, 0.8314696123025453),
  scale: new Vector3(1, 1, 1)
})
junglePlant_06_2.addComponentOrReplace(transform_13)
engine.addEntity(junglePlant_06_2)

const plant_02 = new Entity()
plant_02.setParent(scene)
const gltfShape_8 = new GLTFShape('models/Plant_02/Plant_02.glb')
plant_02.addComponentOrReplace(gltfShape_8)
...
plant_02.addComponentOrReplace(transform_14)
engine.addEntity(plant_02)

const plant_02_2 = new Entity()
plant_02_2.setParent(scene)
plant_02_2.addComponentOrReplace(gltfShape_8)
...
plant_02_2.addComponentOrReplace(transform_15)
...
grass_02_3.addComponentOrReplace(transform_16)
engine.addEntity(grass_02_3)

const pebble_01 = new Entity()
pebble_01.setParent(scene)
const gltfShape_9 = new GLTFShape('models/Pebble_01/Pebble_01.glb')
pebble_01.addComponentOrReplace(gltfShape_9)
const transform_17 = new Transform({
  position: new Vector3(12, 0, 9),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
pebble_01.addComponentOrReplace(transform_17)
engine.addEntity(pebble_01)

const pebble_02 = new Entity()
pebble_02.setParent(scene)
const gltfShape_10 = new GLTFShape('models/Pebble_02/Pebble_02.glb')
pebble_02.addComponentOrReplace(gltfShape_10)
const transform_18 = new Transform({
  position: new Vector3(3.5, 0, 12.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
pebble_02.addComponentOrReplace(transform_18)
engine.addEntity(pebble_02)

const pebble_01_2 = new Entity()
pebble_01_2.setParent(scene)
pebble_01_2.addComponentOrReplace(gltfShape_9)
const transform_19 = new Transform({
  position: new Vector3(3.5, 0, 3.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
pebble_01_2.addComponentOrReplace(transform_19)
engine.addEntity(pebble_01_2)

const pebble_02_2 = new Entity()
pebble_02_2.setParent(scene)
pebble_02_2.addComponentOrReplace(gltfShape_10)
const transform_20 = new Transform({
  position: new Vector3(8, 0, 2),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
pebble_02_2.addComponentOrReplace(transform_20)
engine.addEntity(pebble_02_2)

const pebble_01_3 = new Entity()
pebble_01_3.setParent(scene)
pebble_01_3.addComponentOrReplace(gltfShape_9)
const transform_21 = new Transform({
  position: new Vector3(14, 0, 2.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
pebble_01_3.addComponentOrReplace(transform_21)
engine.addEntity(pebble_01_3)

const pebble_01_4 = new Entity()
pebble_01_4.setParent(scene)
pebble_01_4.addComponentOrReplace(gltfShape_9)
const transform_22 = new Transform({
  position: new Vector3(9.5, 0, 6.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
pebble_01_4.addComponentOrReplace(transform_22)
engine.addEntity(pebble_01_4)

const pebble_01_5 = new Entity()
pebble_01_5.setParent(scene)
pebble_01_5.addComponentOrReplace(gltfShape_9)
const transform_23 = new Transform({
  position: new Vector3(2.5, 0, 10),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
pebble_01_5.addComponentOrReplace(transform_23)
engine.addEntity(pebble_01_5)
...
mushroom_02.addComponentOrReplace(transform_24)
