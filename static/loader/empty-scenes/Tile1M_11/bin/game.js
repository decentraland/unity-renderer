...
grass_01_3.addComponentOrReplace(transform_7)
...
grass_01_4.addComponentOrReplace(transform_8)
...
treePine_01.addComponentOrReplace(transform_11)
...
const transform_12 = new Transform({
  position: new Vector3(7.5, 0, 6.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
rockSmall_01.addComponentOrReplace(transform_12)
engine.addEntity(rockSmall_01)

const rockSmall_02 = new Entity()
rockSmall_02.setParent(scene)
const gltfShape_7 = new GLTFShape('models/RockSmall_02/RockSmall_02.glb')
rockSmall_02.addComponentOrReplace(gltfShape_7)
const transform_13 = new Transform({
  position: new Vector3(5.5, 0, 7.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
rockSmall_02.addComponentOrReplace(transform_13)
...
const transform_14 = new Transform({
  position: new Vector3(7, 0, 9.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
rockSmall_01_2.addComponentOrReplace(transform_14)
engine.addEntity(rockSmall_01_2)

const rockMedium_02 = new Entity()
rockMedium_02.setParent(scene)
const gltfShape_8 = new GLTFShape('models/RockMedium_02/RockMedium_02.glb')
rockMedium_02.addComponentOrReplace(gltfShape_8)
...
rockMedium_02.addComponentOrReplace(transform_15)
engine.addEntity(rockMedium_02)

const rockMedium_03 = new Entity()
rockMedium_03.setParent(scene)
const gltfShape_9 = new GLTFShape('models/RockMedium_03/RockMedium_03.glb')
rockMedium_03.addComponentOrReplace(gltfShape_9)
const transform_16 = new Transform({
  position: new Vector3(10.5, 0, 12),
  rotation: new Quaternion(0, -0.8819212643483552, 0, 0.47139673682599803),
  scale: new Vector3(1, 1, 1)
})
rockMedium_03.addComponentOrReplace(transform_16)
engine.addEntity(rockMedium_03)

const rockMedium_02_2 = new Entity()
rockMedium_02_2.setParent(scene)
rockMedium_02_2.addComponentOrReplace(gltfShape_8)
const transform_17 = new Transform({
  position: new Vector3(3, 0, 3.5),
  rotation: new Quaternion(0, -0.6343932841636456, 0, 0.7730104533627371),
  scale: new Vector3(1, 1, 1)
})
rockMedium_02_2.addComponentOrReplace(transform_17)
...
const transform_18 = new Transform({
  position: new Vector3(12.5, 0, 4.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
rockMedium_01.addComponentOrReplace(transform_18)
...
const gltfShape_13 = new GLTFShape('models/Log_02/Log_02.glb')
log_02.addComponentOrReplace(gltfShape_13)
...
log_02.addComponentOrReplace(transform_21)
...
plant_02.addComponentOrReplace(transform_24)
