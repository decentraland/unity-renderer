...
const transform_7 = new Transform({
  ...
  rotation: new Quaternion(0, 0.9569403357322087, 0, -0.2902846772544623),
  scale: new Vector3(1, 1, 1)
})
...
grass_01_3.addComponentOrReplace(transform_9)
engine.addEntity(grass_01_3)

const grass_05 = new Entity()
grass_05.setParent(scene)
const gltfShape_5 = new GLTFShape('models/Grass_05/Grass_05.glb')
grass_05.addComponentOrReplace(gltfShape_5)
const transform_10 = new Transform({
  position: new Vector3(2, 0, 6),
  rotation: new Quaternion(0, -0.5555702330196023, 0, 0.8314696123025453),
  scale: new Vector3(1, 1, 1)
})
grass_05.addComponentOrReplace(transform_10)
engine.addEntity(grass_05)

const grass_05_2 = new Entity()
grass_05_2.setParent(scene)
grass_05_2.addComponentOrReplace(gltfShape_5)
const transform_11 = new Transform({
  position: new Vector3(14, 0, 9.5),
  rotation: new Quaternion(0, -0.6343932841636455, 0, 0.7730104533627371),
  scale: new Vector3(1, 1, 1)
})
grass_05_2.addComponentOrReplace(transform_11)
engine.addEntity(grass_05_2)

const treeTall_02 = new Entity()
treeTall_02.setParent(scene)
const gltfShape_6 = new GLTFShape('models/TreeTall_02/TreeTall_02.glb')
treeTall_02.addComponentOrReplace(gltfShape_6)
const transform_12 = new Transform({
  position: new Vector3(5, 0, 5),
  rotation: new Quaternion(0, 0.8819212643483552, 0, 0.47139673682599786),
  scale: new Vector3(1, 1, 1)
})
treeTall_02.addComponentOrReplace(transform_12)
engine.addEntity(treeTall_02)

const treeTall_01 = new Entity()
treeTall_01.setParent(scene)
const gltfShape_7 = new GLTFShape('models/TreeTall_01/TreeTall_01.glb')
treeTall_01.addComponentOrReplace(gltfShape_7)
const transform_13 = new Transform({
  position: new Vector3(12.5, 0, 8),
  rotation: new Quaternion(0, -0.6343932841636457, 0, 0.7730104533627371),
  scale: new Vector3(1, 1, 1)
})
treeTall_01.addComponentOrReplace(transform_13)
...
rockSmall_02.addComponentOrReplace(transform_14)
engine.addEntity(rockSmall_02)

const rockSmall_03 = new Entity()
rockSmall_03.setParent(scene)
const gltfShape_9 = new GLTFShape('models/RockSmall_03/RockSmall_03.glb')
rockSmall_03.addComponentOrReplace(gltfShape_9)
const transform_15 = new Transform({
  position: new Vector3(5.5, 0, 4),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
rockSmall_03.addComponentOrReplace(transform_15)
engine.addEntity(rockSmall_03)

const rockSmall_01 = new Entity()
rockSmall_01.setParent(scene)
const gltfShape_10 = new GLTFShape('models/RockSmall_01/RockSmall_01.glb')
rockSmall_01.addComponentOrReplace(gltfShape_10)
...
const gltfShape_11 = new GLTFShape('models/RockMedium_03/RockMedium_03.glb')
rockMedium_03.addComponentOrReplace(gltfShape_11)
const transform_17 = new Transform({
  position: new Vector3(13, 0, 9),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
rockMedium_03.addComponentOrReplace(transform_17)
engine.addEntity(rockMedium_03)

const rockMedium_02 = new Entity()
rockMedium_02.setParent(scene)
const gltfShape_12 = new GLTFShape('models/RockMedium_02/RockMedium_02.glb')
rockMedium_02.addComponentOrReplace(gltfShape_12)
const transform_18 = new Transform({
  position: new Vector3(4, 0, 6.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
rockMedium_02.addComponentOrReplace(transform_18)
engine.addEntity(rockMedium_02)

const pebble_03 = new Entity()
pebble_03.setParent(scene)
const gltfShape_13 = new GLTFShape('models/Pebble_03/Pebble_03.glb')
pebble_03.addComponentOrReplace(gltfShape_13)
const transform_19 = new Transform({
  position: new Vector3(13, 0, 7),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
pebble_03.addComponentOrReplace(transform_19)
engine.addEntity(pebble_03)
...
const transform_20 = new Transform({
  position: new Vector3(6.5, 0, 5.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
pebble_02.addComponentOrReplace(transform_20)
engine.addEntity(pebble_02)

const pebble_01 = new Entity()
pebble_01.setParent(scene)
const gltfShape_15 = new GLTFShape('models/Pebble_01/Pebble_01.glb')
pebble_01.addComponentOrReplace(gltfShape_15)
...
pebble_02_2.addComponentOrReplace(gltfShape_14)
const transform_22 = new Transform({
  position: new Vector3(15, 0, 12),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
pebble_02_2.addComponentOrReplace(transform_22)
...
plant_02.addComponentOrReplace(transform_23)
engine.addEntity(plant_02)

const bush_01 = new Entity()
bush_01.setParent(scene)
const gltfShape_17 = new GLTFShape('models/Bush_01/Bush_01.glb')
bush_01.addComponentOrReplace(gltfShape_17)
const transform_24 = new Transform({
  position: new Vector3(6.5, 0, 14),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
bush_01.addComponentOrReplace(transform_24)
engine.addEntity(bush_01)

const plant_04 = new Entity()
plant_04.setParent(scene)
const gltfShape_18 = new GLTFShape('models/Plant_04/Plant_04.glb')
plant_04.addComponentOrReplace(gltfShape_18)
const transform_25 = new Transform({
  position: new Vector3(5.5, 0, 14),
  rotation: new Quaternion(0, -0.0980171403295608, 0, 0.9951847266721976),
  scale: new Vector3(1, 1, 1)
})
plant_04.addComponentOrReplace(transform_25)
