...
const gltfShape_2 = new GLTFShape('models/TreeRoundPine_02/TreeRoundPine_02.glb')
treeRoundPine_02.addComponentOrReplace(gltfShape_2)
...
treeRoundPine_02.addComponentOrReplace(transform_3)
engine.addEntity(treeRoundPine_02)

const treeStump_01 = new Entity()
treeStump_01.setParent(scene)
const gltfShape_3 = new GLTFShape('models/TreeStump_01/TreeStump_01.glb')
treeStump_01.addComponentOrReplace(gltfShape_3)
const transform_4 = new Transform({
  position: new Vector3(5.5, 0, 12),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
treeStump_01.addComponentOrReplace(transform_4)
engine.addEntity(treeStump_01)

const rockSmall_01 = new Entity()
rockSmall_01.setParent(scene)
const gltfShape_4 = new GLTFShape('models/RockSmall_01/RockSmall_01.glb')
rockSmall_01.addComponentOrReplace(gltfShape_4)
const transform_5 = new Transform({
  position: new Vector3(13.5, 0, 10),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
rockSmall_01.addComponentOrReplace(transform_5)
engine.addEntity(rockSmall_01)

const rockSmall_03 = new Entity()
rockSmall_03.setParent(scene)
const gltfShape_5 = new GLTFShape('models/RockSmall_03/RockSmall_03.glb')
rockSmall_03.addComponentOrReplace(gltfShape_5)
...
rockSmall_03.addComponentOrReplace(transform_6)
engine.addEntity(rockSmall_03)

const bush_03 = new Entity()
bush_03.setParent(scene)
const gltfShape_6 = new GLTFShape('models/Bush_03/Bush_03.glb')
bush_03.addComponentOrReplace(gltfShape_6)
const transform_7 = new Transform({
  position: new Vector3(6, 0, 5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
bush_03.addComponentOrReplace(transform_7)
engine.addEntity(bush_03)

const bush_01 = new Entity()
bush_01.setParent(scene)
const gltfShape_7 = new GLTFShape('models/Bush_01/Bush_01.glb')
bush_01.addComponentOrReplace(gltfShape_7)
const transform_8 = new Transform({
  position: new Vector3(13, 0, 12),
  rotation: new Quaternion(0, 0.9951847266721967, 0, -0.09801714032956049),
  scale: new Vector3(1, 1, 1)
})
bush_01.addComponentOrReplace(transform_8)
...
plant_02.addComponentOrReplace(transform_9)
engine.addEntity(plant_02)

const grass_01 = new Entity()
grass_01.setParent(scene)
const gltfShape_9 = new GLTFShape('models/Grass_01/Grass_01.glb')
grass_01.addComponentOrReplace(gltfShape_9)
const transform_10 = new Transform({
  position: new Vector3(13.5, 0, 5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
...
const gltfShape_10 = new GLTFShape('models/Grass_02/Grass_02.glb')
grass_02.addComponentOrReplace(gltfShape_10)
...
const gltfShape_13 = new GLTFShape('models/TreeRoundPine_03/TreeRoundPine_03.glb')
treeRoundPine_03.addComponentOrReplace(gltfShape_13)
const transform_19 = new Transform({
  position: new Vector3(12.5, 0, 11),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
treeRoundPine_03.addComponentOrReplace(transform_19)
