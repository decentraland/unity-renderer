...
namespace DCL.Components
{
    public class RendereableAssetLoadHelper
    {
        public enum LoadingType
        {
            ...
            ASSET_BUNDLE_ONLY, // only for debugging
            GLTF_ONLY
        }
        ...
        public static bool allowAssetBundles = true;
        ...
        public void Load(string targetUrl, bool useAssetBundles = true)
        {
            ...
            LoadingType targetLoadingType = useAssetBundles ? LoadingType.ASSET_BUNDLE_WITH_GLTF_FALLBACK : LoadingType.GLTF_ONLY;
            if (!allowAssetBundles && targetLoadingType == LoadingType.ASSET_BUNDLE_WITH_GLTF_FALLBACK || targetLoadingType == LoadingType.ASSET_BUNDLE_ONLY)
                targetLoadingType = LoadingType.GLTF_ONLY;
            
            switch (targetLoadingType)
            {
