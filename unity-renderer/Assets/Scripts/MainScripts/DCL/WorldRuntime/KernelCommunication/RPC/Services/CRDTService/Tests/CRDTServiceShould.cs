...
namespace Tests
{
    public class CRDTServiceShould
    {
        ...
        public void SetUp()
        {
            ...
            {
                CRDTServiceImpl.RegisterService(port, new CRDTServiceImpl());
            });
        ...
        {
            TestClient testClient = await TestClient.Create(testClientTransport, ICRDTService<RPCContext>.ServiceName);
