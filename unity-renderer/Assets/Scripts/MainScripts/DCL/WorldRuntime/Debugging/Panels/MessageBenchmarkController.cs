    ...
    public class MessageBenchmarkController : MonoBehaviour, IBenchmarkController
    {
        ...
        IEnumerator UpdateTotalMs()
        {
            while (true)
            {
                ...
                statsPanel.SetCellText((int) Columns.LOGIC_MS, (int) Rows.TOTAL,
                    logicTotalTime.ToString("N3", CultureInfo.InvariantCulture) + "ms");
                statsPanel.SetCellText((int) Columns.DECODE_MS, (int) Rows.TOTAL,
                    decodeTotalTime.ToString("N3", CultureInfo.InvariantCulture) + "ms");
        ...
        private void OnMessageProcessEnds(string s)
        {
            ...
            statsPanel.SetCellText((int) Columns.RATIO, (int) stringToRow[s],
                finalRatio.ToString("N1", CultureInfo.InvariantCulture) + "%");
            ...
            statsPanel.SetCellText((int) Columns.TOTAL_TIME, (int) stringToRow[s],
                totalSecs.ToString("N2", CultureInfo.InvariantCulture) + "secs");
            ...
            if (stringToRow[s] != Rows.SCENE_LOAD)
            {
                ...
                statsPanel.SetCellText((int) Columns.LOGIC_MS, (int) stringToRow[s],
                    avg.ToString("N3", CultureInfo.InvariantCulture) + "ms");
