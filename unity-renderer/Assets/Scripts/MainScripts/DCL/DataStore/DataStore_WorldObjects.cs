...
namespace DCL
{
    public class DataStore_WorldObjects
    {
        public class SceneData
        {
            ...
            // FD:: Try caching all the renderers with a struct for later retrieval
            ...
            public readonly BaseDictionary<Renderer, bool> renderersCachedShadow = new BaseDictionary<Renderer, bool>();
        }
