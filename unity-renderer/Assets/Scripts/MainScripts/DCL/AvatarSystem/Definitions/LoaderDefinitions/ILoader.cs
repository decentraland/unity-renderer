...
namespace AvatarSystem
{
    public interface ILoader : IDisposable
    {
        ...
        UniTask Load(WearableItem bodyshape, WearableItem eyes, WearableItem eyebrows, WearableItem mouth, List<WearableItem> wearables, AvatarSettings settings, IBaseAvatar baseAvatar, CancellationToken ct = default);
        Transform[] GetBones();
