...
namespace AvatarSystem
{
    ...
    public class AvatarWithHologram : IAvatar
    {
        ...
        /// <param name="ct"></param>
        public async UniTask Load(List<string> wearablesIds, List<string> emotesIds, 
            AvatarSettings settings, bool showSpawnParticles, CancellationToken ct = default)
        {
            ...
            try
            {
                ...
                baseAvatar.Initialize(showSpawnParticles);
