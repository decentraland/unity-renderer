...
namespace DCL
{
    public class AssetPromise_Material : AssetPromise<Asset_Material>
    {
        ...
        protected override void OnLoad(Action OnSuccess, Action OnFail) { throw new NotImplementedException(); }

        public override object GetId() { throw new NotImplementedException(); }
    }
}