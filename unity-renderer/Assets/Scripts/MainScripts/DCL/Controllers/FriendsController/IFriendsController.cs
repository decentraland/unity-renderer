...
namespace DCL.Social.Friends
{
    public interface IFriendsController : IService
    {
        ...
        UniTask<IEnumerable<SocialFriendRequest>> GetFriendRequestsAsync(int sentLimit, int sentSkip, int receivedLimit, int receivedSkip, CancellationToken cancellationToken = default);
