...
{
    public class HintRequestServiceTests
    {
        ...
        public void Setup()
        {
            _hintRequestSources = new List<IHintRequestSource>();
        ...
        [Category("Explicit")]
        [Test]
        public async UniTask RequestHintsFromSources_EmptyHintSourceList_ReturnsEmptyHintList()
        {
            // Act
