...
internal class SceneSearchHandler : ISectionSearchHandler
{
    ...
    public void SetSearchableList(List<SceneSearchInfo> list) { scenesSearchHandler.SetSearchableList(list); }

    public void AddItem(SceneSearchInfo item) { scenesSearchHandler.AddItem(item); }

    public void RemoveItem(SceneSearchInfo item) { scenesSearchHandler.RemoveItem(item); }
    ...
    void ISectionSearchHandler.SetSortOrder(bool isDescending) { scenesSearchHandler.NotifySortOrderChanged(isDescending); }
