    ...
    public class BackpackEditorHUDControllerShould
    {
        ...
        public void SetUp()
        {
            ...
            backpackEditorHUDController = new BackpackEditorHUDController(
                ...
                avatarSlotsHUDController,
                new OutfitsController(Substitute.For<IOutfitsSectionComponentView>(), new LambdaOutfitsService(Substitute.For<ILambdasService>(),Substitute.For<IServiceProviders>()), userProfileBridge, Substitute.For<IWearablesCatalogService>(), Substitute.For<DataStore>()));
        }
