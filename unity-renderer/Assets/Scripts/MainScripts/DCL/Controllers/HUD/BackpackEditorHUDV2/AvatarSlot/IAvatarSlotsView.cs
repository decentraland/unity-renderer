...
namespace DCL.Backpack
{
    ...
    {
        delegate void ToggleAvatarSlotDelegate(string slotCategory, bool supportColor, CharacterPreviewController.CameraFocus previewCameraFocus, float? orthoGraphicSize, bool isSelected);
