...
namespace DCL.Backpack
{
    public class AvatarSlotsHUDControllerShould
    {
        ...
        {
            avatarSlotsHUDController.ToggleSlot("tiara", false, CharacterPreviewController.CameraFocus.DefaultEditing, 2, true);
            avatarSlotsView.DidNotReceive().DisablePreviousSlot(Arg.Any<string>());

            avatarSlotsHUDController.ToggleSlot("mask", false, CharacterPreviewController.CameraFocus.DefaultEditing, 2, true);
