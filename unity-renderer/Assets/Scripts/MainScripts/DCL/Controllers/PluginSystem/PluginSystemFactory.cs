...
namespace DCL
{
    public static class PluginSystemFactory
    {
        public static PluginSystem Create()
        {
            ...
            // pluginSystem.RegisterWithFlag<LoadingScreenV2Plugin>(() => new LoadingScreenV2Plugin(Environment.i.serviceLocator.Get<IAddressableResourceProvider>()), "loading_screen_v2"); // TODO:: FD:: remove this
