...
namespace DCL
{
    public static class PluginSystemFactory
    {
        public static PluginSystem Create()
        {
            ...
            pluginSystem.RegisterWithFlag<TutorialController>(() => new TutorialController(Environment.i.serviceLocator.Get<IAddressableResourceProvider>(), DataStore.i.common, DataStore.i.settings, DataStore.i.exploreV2), "tutorial");
