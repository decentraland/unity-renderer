...
public class HighlightsSubSectionComponentController : IHighlightsSubSectionComponentController
{
        ...
        IFriendsController friendsController)
    {
        ...
        this.view.OnEventSubscribeEventClicked += ExploreEventsHelpers.SubscribeToEvent;
        this.view.OnEventUnsubscribeEventClicked += ExploreEventsHelpers.UnsubscribeToEvent;
    ...
    public void Dispose()
    {
        ...
        view.OnEventSubscribeEventClicked -= ExploreEventsHelpers.SubscribeToEvent;
        view.OnEventUnsubscribeEventClicked -= ExploreEventsHelpers.UnsubscribeToEvent;
