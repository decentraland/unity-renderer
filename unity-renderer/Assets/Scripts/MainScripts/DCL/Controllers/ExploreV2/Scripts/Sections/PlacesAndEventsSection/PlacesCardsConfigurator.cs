...
public static class PlacesCardsConfigurator
{
    ...
    public static PlaceCardComponentView Configure(PlaceCardComponentView placeCard, PlaceCardComponentModel placeInfo, Action<PlaceCardComponentModel> OnPlaceInfoClicked, Action<HotSceneInfo> OnPlaceJumpInClicked, Action<HotSceneInfo> OnFavoriteClicked)
    {
        ...
        placeCard.onFavoriteClick.RemoveAllListeners();
        placeCard.onFavoriteClick.AddListener(() => OnFavoriteClicked?.Invoke(placeInfo.hotSceneInfo));
