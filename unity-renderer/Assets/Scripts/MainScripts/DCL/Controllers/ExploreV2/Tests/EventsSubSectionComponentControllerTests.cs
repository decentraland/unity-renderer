...
public class EventsSubSectionComponentControllerTests
{
    ...
    public void SetUp()
    {
        ...
        eventsSubSectionComponentController = new EventsSubSectionComponentController(eventsSubSectionComponentView, eventsAPIController, exploreV2Analytics, DataStore.i, Substitute.For<IUserProfileBridge>());
    }
