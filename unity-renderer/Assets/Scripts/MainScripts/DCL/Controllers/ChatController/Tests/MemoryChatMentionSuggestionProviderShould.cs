...
namespace DCL.Social.Chat.Mentions
{
    public class MemoryChatMentionSuggestionProviderShould
    {
        ...
        [UnityTest]
        public IEnumerator GetProfilesFromUserProfileController() => UniTask.ToCoroutine(async () =>
        {
            List<UserProfile> profiles = await mentionSuggestionProvider.GetProfilesStartingWith("hey", 5, default(CancellationToken));
        ...
        [UnityTest]
        public IEnumerator GetNearbyProfiles() => UniTask.ToCoroutine(async () =>
        {
        ...
        [UnityTest]
        public IEnumerator GetProfilesFromChannels() => UniTask.ToCoroutine(async () =>
        {
