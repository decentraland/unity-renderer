...
namespace DCL
{
    public interface IAvatarMeshCombinerHelper : IDisposable
    {
        ...
        public bool Combine(SkinnedMeshRenderer bonesContainer, List<SkinnedMeshRenderer> renderersToCombine, bool keepPose = true);
        public bool Combine(SkinnedMeshRenderer bonesContainer, List<SkinnedMeshRenderer> renderersToCombine, Material materialAsset, bool keepPose = true);
    }
    ...
    public class AvatarMeshCombinerHelper : IAvatarMeshCombinerHelper
    {
        ...
        public bool Combine(SkinnedMeshRenderer bonesContainer, List<SkinnedMeshRenderer> renderersToCombine, bool keepPose = true) { return Combine(bonesContainer, renderersToCombine, Resources.Load<Material>("Avatar Material"), keepPose); }
        ...
        public bool Combine(SkinnedMeshRenderer bonesContainer, List<SkinnedMeshRenderer> renderersToCombine, Material materialAsset, bool keepPose)
        {
