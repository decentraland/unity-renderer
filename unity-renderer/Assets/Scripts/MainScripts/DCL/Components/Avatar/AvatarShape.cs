...
namespace DCL
{
    public class AvatarShape : BaseComponent
    {
        ...
        private void Awake()
        {
            ...
            avatarRenderer.OnImpostorAlphaValueUpdate += (newAlphaValue) => avatarMovementController.movementLerpWait = newAlphaValue > 0.1f ? DataStore.i.avatarsLOD.testPanel.impostorsMovementInterpolationWait.Get() : 0f;
        }
