...
{
    public class WebRequestLoaderAsync : ILoaderAsync
    {
        ...
        public WebRequestLoaderAsync(string rootURI, IWebRequestController webRequestController, AssetIdConverter fileToHashConverter = null)
        {
        ...
        public async Task LoadStream(string filePath)
        {
            if (filePath == null)
            {
