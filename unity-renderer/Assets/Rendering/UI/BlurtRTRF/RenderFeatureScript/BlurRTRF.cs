...
namespace BlurRT
{
    ...
    public class BlurRTRF : ScriptableRendererFeature
    {
        ...
        public class BlurSettings
        {
            ...
            [Range(1, 30)] public int blurPasses = 1; // number of blur passes
            [Range(1, 6)] public int downSample = 1; // downsample amount
        ...
        private class CustomRenderPass : ScriptableRenderPass 
        {
            ...
            public override void Configure(CommandBuffer cmd, RenderTextureDescriptor cameraTextureDescriptor)
            {
                for (int i = 0; i < 2; i++)
                {
                    int id = Shader.PropertyToID("BlurURP_HLSL" + Random.Range(int.MinValue, int.MaxValue)); // get random id
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                opaqueDesc.depthBufferBits = 0; // set depth buffer bits to 0
