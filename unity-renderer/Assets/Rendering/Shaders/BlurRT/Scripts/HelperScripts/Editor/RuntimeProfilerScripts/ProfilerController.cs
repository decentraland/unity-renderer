...
public class ProfilerController : MonoBehaviour
{
    ...
    *************************************************************************************************************/
    ...
    [Header("UI Position")]
    [SerializeField] private float posX = 10;
    [SerializeField] private float posY = 140;
    [SerializeField] private float dimX = 250;
    [SerializeField] private float dimY = 64;
    ...
    void OnGUI()
    {
        GUI.TextArea(new Rect(posX, posY, dimX, dimY), statsText);
    }
}
