Shader "Unlit/S_FinalGhost"
{
    Properties
    {
        ...
        _RefractionScale("RefractionScale", Float) = 100
        _RefractionIntensity("RefractionIntensity", Float) = 0
        _RefractionSpeed("RefractionSpeed", Vector) = (0.01, 0.02, 0, 0)
...
SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
{
    ...
    float4 _ScreenPosition_974623aedad142c58c9223bc5b0667f0_Out_0 = float4(IN.ScreenPosition.xy / IN.ScreenPosition.w, 0, 0);
    float4 _ScreenPosition_ea0c39d45de445b5bd2646afd983e118_Out_0 = float4(IN.ScreenPosition.xy / IN.ScreenPosition.w, 0, 0);
    float2 _Property_5a2e88dc259d4f29a10a25771d890391_Out_0 = _RefractionSpeed;
    float2 _Multiply_0f0b545887064293ba4bf93cf3ef389a_Out_2;
    Unity_Multiply_float((IN.TimeParameters.x.xx), _Property_5a2e88dc259d4f29a10a25771d890391_Out_0, _Multiply_0f0b545887064293ba4bf93cf3ef389a_Out_2);
    float2 _TilingAndOffset_daa641c6541c4b63977b8537ecc81545_Out_3;
    Unity_TilingAndOffset_float((_ScreenPosition_ea0c39d45de445b5bd2646afd983e118_Out_0.xy), float2 (1, 1), _Multiply_0f0b545887064293ba4bf93cf3ef389a_Out_2, _TilingAndOffset_daa641c6541c4b63977b8537ecc81545_Out_3);
    float _Property_f7128f02b1f6443aa12d793181db7bc5_Out_0 = _RefractionScale;
    float _SimpleNoise_14d247c9a8374eee880cdf0161fe6ded_Out_2;
    Unity_SimpleNoise_float(_TilingAndOffset_daa641c6541c4b63977b8537ecc81545_Out_3, _Property_f7128f02b1f6443aa12d793181db7bc5_Out_0, _SimpleNoise_14d247c9a8374eee880cdf0161fe6ded_Out_2);
    float4 _Multiply_8d03bdbf74174091a0460f2e6e98968d_Out_2;
    Unity_Multiply_float(_ScreenPosition_974623aedad142c58c9223bc5b0667f0_Out_0, (_SimpleNoise_14d247c9a8374eee880cdf0161fe6ded_Out_2.xxxx), _Multiply_8d03bdbf74174091a0460f2e6e98968d_Out_2);
    float _Property_c0d3c5ef5f1b42f7abe5758ebba6240d_Out_0 = _RefractionIntensity;
    float4 _Multiply_abf01723eb3647f188b6e28c37b9a035_Out_2;
    Unity_Multiply_float(_Multiply_8d03bdbf74174091a0460f2e6e98968d_Out_2, (_Property_c0d3c5ef5f1b42f7abe5758ebba6240d_Out_0.xxxx), _Multiply_abf01723eb3647f188b6e28c37b9a035_Out_2);
    float4 _Add_c4e600d6056d4023b84950d334bab8a4_Out_2;
    Unity_Add_float4(_ScreenPosition_974623aedad142c58c9223bc5b0667f0_Out_0, _Multiply_abf01723eb3647f188b6e28c37b9a035_Out_2, _Add_c4e600d6056d4023b84950d334bab8a4_Out_2);
    float3 _SceneColor_503dc65774c8493883e3c43314fe2a60_Out_1;
    Unity_SceneColor_float(_Add_c4e600d6056d4023b84950d334bab8a4_Out_2, _SceneColor_503dc65774c8493883e3c43314fe2a60_Out_1);
