...
namespace DCL
{
    public class Logger
    {
        ...
        {
            unityLogger.Log(LogType.Error, tag, message, context);
        }

        public void Warning(string message, Object context = null)
        {
            unityLogger.Log(LogType.Warning, tag, message, context);
        }

        public void Exception(string message, Object context = null)
        {
            unityLogger.Log(LogType.Exception, tag, message, context);
        }
    }
}