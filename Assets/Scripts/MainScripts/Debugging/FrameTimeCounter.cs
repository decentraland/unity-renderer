...
public class FrameTimeCounter : MonoBehaviour {
    ...
    void UpdateStats()
    {
        stats[0] = perf.GetPercentile(0);
        stats[1] = perf.GetPercentile(1);
        stats[2] = perf.GetPercentile(5);
        stats[3] = perf.GetPercentile(10);
        stats[4] = perf.GetPercentile(25);
        stats[5] = perf.GetPercentile(50);
    }
}
