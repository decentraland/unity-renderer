...
public class VisualTestController : MonoBehaviour
{
    ...
    {
        yield return VisualTestHelpers.TakeSnapshot("snapshot_1.png", new Vector3(10f, 10f, 0f));
        yield return VisualTestHelpers.TakeSnapshot("snapshot_2.png", new Vector3(0f, 10f, 0f));
        yield return VisualTestHelpers.TakeSnapshot("snapshot_3.png", new Vector3(-10f, 10f, 0f));
        yield return VisualTestHelpers.TakeSnapshot("snapshot_4.png", new Vector3(0f, 10f, -10f));
    }
}