...
export const Logo = (props: React.SVGProps<SVGSVGElement>) => (
  <svg height="31" width="31" viewBox="0 0 31 31" {...props} className={'dcl-logo ' + (props.className || '')} xmlns="http://www.w3.org/2000/svg">
    <defs>
    ...
    <g>
      <title>Layer 1</title>
      <path d="m15.45 30.91c8.5327 0 15.45-6.9194 15.45-15.455 0-8.5355-6.9171-15.455-15.45-15.455-8.5328 0-15.45 6.9194-15.45 15.455 0 8.5356 6.9171 15.455 15.45 15.455z" clipRule="evenodd" fill="url(#c)" fillRule="evenodd" />
      ...
      <path d="m6.1802 27.819c2.5801 1.9396 5.7937 3.091 9.2699 3.091s6.6898-1.1514 9.2699-3.091h-18.54z" clipRule="evenodd" fill="#FF2D55" fillRule="evenodd" />
      ...
      <path d="m20.727 13.909c2.1331 0 3.8624-1.7298 3.8624-3.8637 0-2.1339-1.7293-3.8637-3.8624-3.8637-2.1332 0-3.8625 1.7299-3.8625 3.8637 0 2.1339 1.7293 3.8637 3.8625 3.8637z" clipRule="evenodd" fill="#FFC95B" fillRule="evenodd" />
      <path d="m10.947 7.7278c1.0666 0 1.9312-0.86493 1.9312-1.9319s-0.8646-1.9319-1.9312-1.9319c-1.0666 0-1.9312 0.86493-1.9312 1.9319s0.86464 1.9319 1.9312 1.9319z" clipRule="evenodd" fill="#FFC95B" fillRule="evenodd" />
    </g>
  </svg>
);
