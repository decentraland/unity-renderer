...
import type { PermissionItem } from 'protocol-gen/decentraland/kernel/apis/permissions.gen'
import type { EventData } from 'protocol-gen/decentraland/kernel/apis/engine_api.gen'
import type { RpcClientPort } from '@dcl/rpc'
import type { RpcSceneControllerServiceDefinition } from 'protocol-gen/decentraland/renderer/renderer_services/scene_controller.gen'
