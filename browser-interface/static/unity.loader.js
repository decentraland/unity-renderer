function createUnityInstance(canvas, config, onProgress) {
  console.log('PRAVS - createUnityInstance...')
  ...
  var Module = {
    ...
    locateFile: function (url) {
      console.log('PRAVS - locateFile - 1')
      if (url == "build.wasm") {
        console.log('PRAVS - locateFile: build.wasm', this.codeUrl)
        return this.codeUrl;
      }
      if (url == "build.worker.js") {
        console.log('PRAVS - locateFile: build.worker.js', this.workerUrl)
